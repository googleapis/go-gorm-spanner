...
// TODO: Replace this with the standard spanner.PGJsonB type when it has a gorm data type

type NullJsonB spanner.PGJsonB

func (b *NullJsonB) GormDataType() string {
	return "jsonb"
}
